                  ...
                  <table class="table dataTable my-0" id="dataTable">
                      ...
                      <tbody>
                          <tr>
                              ...
                              <td>2008/11/28</td>
                              <td>$162,700</td>
                              <td><a href="{!! route('user.edit',1) !!}" class="btn btn-warning btn-icon-split" role="button" style="background-color: #f4b400;"><span class="text-white text"><i class="fa fa-edit"></i></span></a></td>
