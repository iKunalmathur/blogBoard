                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch" style="margin-top: 38px;"><input class="custom-control-input" type="checkbox" checked id="formCheck-1"><label class="custom-control-label" for="formCheck-1"><strong>Active</strong></label></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
