            ...
            {{-- @method('PUT') --}}
              ...
              <div class="avatar-upload">
                ...
                <div class="avatar-preview">
                  <div id="imagePreview" style="background-image: url({{asset(Storage::disk('local')->url('public/users_image/zgcthGixBCQMvuzIoOFjXM3qmIvKlXyrxBpF5CFM.png'))}});">
                  </div>
                </div>
              </div>
        ...
        <div class="col">
          <div class="card shadow mb-3">
            ...
            <div class="card-body">
              ...
              <div class="form-row">
                <div class="col">
                  <div class="form-group"><label for="old_password"><strong>Admin Password</strong></label><input class="form-control" required type="text" name="old_password"></div>
                </div>
                <div class="col">
