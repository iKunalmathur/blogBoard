...
@section('main-content')
  <div class="container-fluid">
      <h3 class="text-dark mb-4">Edit Permission</h3>
      <div class="row mb-3">
          <div class="col-lg-8">
                  ...
                  <div class="col">
                      <div class="card shadow mb-3">
                          <div class="card-header py-3">
                              <p class="text-primary m-0 font-weight-bold">Edit Permission<br></p>
                          </div>
                          <div class="card-body">
                              <form>
                                  <div class="form-row">
                                      <div class="col">
                                          <div class="form-group"><label for="username"><strong>Permission Title</strong></label><input class="form-control" type="text" placeholder="username" name="username"></div>
                                      </div>
                                  </div>
                                  <div class="form-row">
                                      <div class="col">
                                          <div class="form-group"><label for="first_name"><strong>Permission for&nbsp;</strong></label><select class="form-control"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select></div>
                                      </div>
                                      <div class="col">
                                          <div class="form-group"><label for="first_name"><strong>Create Category</strong></label>
                                              <div class="form-row">
                                                  ...
                                                  <div class="col"><button class="btn btn-primary btn-sm border rounded" type="submit" style="background-color: #4285f4;width: 39px;height: 37px;filter: brightness(100%);"><span class="text-white-50 icon"><i class="fas fa-plus"></i></span></button></div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
