                                          ...
                                          <div class="form-row">
                                              ...
                                              <div class="col">
                                                  <div class="form-group" style="margin: 0px;margin-top: 38px;margin-bottom: 0px;">
                                                      <div class="custom-control custom-switch"><input class="custom-control-input" checked type="checkbox" id="formCheck-1"><label class="custom-control-label" for="formCheck-1"><strong>Publish</strong><br></label></div>
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="form-row">
