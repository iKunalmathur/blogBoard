...
@include('includes.notify')
  <div class="container-fluid">
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
      <h3 class="text-dark mb-0">Edit Post</h3>
    </div>
    <div class="card shadow">
      <div class="card-header py-3">
        <p class="text-primary m-0 font-weight-bold">Edit Post Info</p>
      </div>
      <div class="card-body">
        <div class="row mb-3">
          <div class="col-lg-8">
                ...
                <div class="card shadow mb-3">
                  <div class="card-body">
                    ...
                    @method("put")
                      <div class="form-row">
                        <div class="col">
                          <div class="form-group"><label for="title"><strong>Title</strong></label><input class="form-control" type="text" id="title" name="title" value="{{ $post->title }}"></div>
                        </div>
                        <div class="col">
                          <div class="form-group"><label for="subtitle"><strong>Subtitle</strong><br></label><input class="form-control" type="text"  name="subtitle" value="{{ $post->subtitle }}"></div>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col">
                      ...
                      <div class="form-group">
                        <div class="form-row">
                          ...
                          <div class="col">
                            <a href="{!! route('post.index') !!}" class="btn btn-warning btn-sm" type="submit" style="color: #212529;background-color: #f4b400;">Back</a>
                          </div>
                        </div>
                      </div>
                  </div>
          ...
          <div class="col-lg-4">
            <div class="card mb-3">
              <div class="card-body text-center shadow"><img class="img-thumbnail mb-3 mt-4" src="{{asset(Storage::disk('local')->url($post->image))}}" width="200" height="140">
