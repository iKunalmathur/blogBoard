                ...
                <div class="card shadow mb-3">
                  <div class="card-body">
                    <form action="{!! route('category.update',$category->id) !!}" method="post">
                      ...
                      <div class="form-row">
                        <div class="col">
                          <div class="form-group"><label for="title"><strong>Category title</strong><br></label><input class="form-control" type="text" id="title" name="title" value="{{ $category->title }}" autofocus></div>
                          <div class="form-group"><label for="slug"><strong>Slug</strong><br></label><input class="form-control" type="text" id="slug" name="slug" value="{{ $category->slug }}"></div>
                        </div>
                        <div class="col"></div>
                      </div>
