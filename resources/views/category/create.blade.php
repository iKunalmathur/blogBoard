                ...
                <div class="card shadow mb-3">
                  <div class="card-body">
                    <form action="{!! route('category.store') !!}" method="post">
                      ...
                      <div class="form-row">
                        <div class="col">
                          <div class="form-group"><label for="title"><strong>Category title</strong><br></label><input class="form-control" type="text" id="title" name="title" autofocus value="{{ old('title') }}"></div>
